...
class ZipStream:
    ...
    def __init__(self, files, arc_path='', compression=ZIP_DEFLATED):
    ...
    def __iter__(self):
        for file in self.files:
            ...
            arc_filename = os.path.join (self.arc_path, basename)
            for data in self.zip_file (file, arc_filename):
                yield data

        for data in self.archive_footer ():
            yield data
