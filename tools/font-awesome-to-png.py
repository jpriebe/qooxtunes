...
def export_icon(icon, size, filename, font, fontsize, color):
...
parser.add_argument("--fontsize", type=int, default=0,
        help="Font size in pixels (default: size)")
...
for icon in selected_icons:
    ...
    print("Exporting icon \"%s\" as %s (%ix%i pixels) with fontsize %i" %
            (icon, filename, size, size, fontsize))

    export_icon(icon, size, filename, font, fontsize, color)
